...
static a2020_algo_param algo_dv_param[] = 
{
    ...
    { A2020_CMD_ALGO_PARAMID, 0x0002, A2020_CMD_ALGO_PARAM, 0x0001 }, //0x8017:SetAlgorithmParmID, 0x0002:Microphone Configuration, 0x8018:SetAlgorithmParm, 0x0002:1-mic Desktop/Vehicle (DV)
    ...
    { A2020_CMD_ALGO_PARAMID, 0x0040, A2020_CMD_ALGO_PARAM, 0xfffc }, //0x8017:SetAlgorithmParmID, 0x0040:Tx-out Limiter Max Level (dB), 0x8018:SetAlgorithmParm, 0xFFF7:(-9 dB)

    { A2020_CMD_ALGO_PARAMID, 0x0020, A2020_CMD_ALGO_PARAM, 0x0001 }, //0x8017:SetAlgorithmParmID, 0x0020:Tx PostEq Mode, 0x8018:SetAlgorithmParm, 0x0000:Off
    { A2020_CMD_ALGO_PARAMID, 0x001F, A2020_CMD_ALGO_PARAM, 0x0001 }, //0x8017:SetAlgorithmParmID, 0x001F:Rx PostEq Mode, 0x8018:SetAlgorithmParm, 0x0000:Off
    { A2020_CMD_ALGO_PARAMID, 0x0030, A2020_CMD_ALGO_PARAM, 0x0001 }, //0x8017:SetAlgorithmParmID, 0x0030:Tx MBC Mode, 0x8018:SetAlgorithmParm, 0x0000:Off
    { A2020_CMD_ALGO_PARAMID, 0x0031, A2020_CMD_ALGO_PARAM, 0x0000 }, //0x8017:SetAlgorithmParmID, 0x0031:Rx MBC Mode, 0x8018:SetAlgorithmParm, 0x0001:On
...
// 20111004 jmlee 1mic only receiver path  "CLOSE_1MIC_VPOFF_TALK"
static a2020_algo_param algo_ct_1MIC_VPOFF_param[] =  
{
    //Set Algorithm Parameter    
    { A2020_CMD_ALGO_PARAMID, 0x0002, A2020_CMD_ALGO_PARAM, 0x0000 },
    { A2020_CMD_ALGO_PARAMID, 0x004B, A2020_CMD_ALGO_PARAM, /*0x0001*/0x0000 },
    { A2020_CMD_ALGO_PARAMID, 0x0015, A2020_CMD_ALGO_PARAM, 0x0000 },
    { A2020_CMD_ALGO_PARAMID, 0x0016, A2020_CMD_ALGO_PARAM, 0xFFE6 },
    { A2020_CMD_ALGO_PARAMID, 0x0003, A2020_CMD_ALGO_PARAM, 0x0001 },
    ...
    { A2020_CMD_ALGO_PARAMID, 0x0025, A2020_CMD_ALGO_PARAM, 0x0000 },
    { A2020_CMD_ALGO_PARAMID, 0x003D, A2020_CMD_ALGO_PARAM, 0x000B },
#if 1 // 20111102 jmlee h/w test code
    { A2020_CMD_ALGO_PARAMID, 0x000E, A2020_CMD_ALGO_PARAM, 0x0001 },
    { A2020_CMD_ALGO_PARAMID, 0x004C, A2020_CMD_ALGO_PARAM, 0x0006 },
#else
    { A2020_CMD_ALGO_PARAMID, 0x000E, A2020_CMD_ALGO_PARAM, /*0x0001*/0x0000 },
    { A2020_CMD_ALGO_PARAMID, 0x004C, A2020_CMD_ALGO_PARAM, 0x0001 },
#endif    
...
{
    { A2020_CMD_VOICE_PROCESSING, 0x0000 }, //Voice Processing Off
    { 0xFFFF, 0xFFFF },
};
...
int A2020_msgCB(u16 read_byte, byte * read_buf)
{
    ...
    msg.buf = read_buf;
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
    printk( "[Snd_audience_a2020] A2020_msgCB  start i2c_transfer !!!\n");
#endif	
    ret_value = i2c_transfer(audience_a2020_i2c_client->adapter, &msg, 1);
...
int aud_bootimage_download_1st(void)
{
...
#if 1  // use only 1 image
    for (firmware_index = 0; firmware_index <=  (len-onetime_down_byte); )
    	{
		msg.addr = audience_a2020_i2c_client->addr;
		msg.flags = 0;
		msg.len = onetime_down_byte;
		msg.buf = (char *)a2020_firmware_image1+firmware_index;
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
		    printk( "[Snd_audience_a2020] aud_bootimage_download_1st i2c_transfer Before !!!\n");   
#endif
		ret_val = i2c_transfer(audience_a2020_i2c_client->adapter, &msg, 1);
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
		    printk( "[Snd_audience_a2020] aud_bootimage_download_1st i2c_transfer After !!! [[ loop_cnt : %d]] \n",loop_cnt);   
#endif
		if (ret_val < 0){
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
	    ...
	    firmware_index = firmware_index +onetime_down_byte;
	    loop_cnt++;
	    mdelay(1);
    	}
	
       {
		msg.addr = audience_a2020_i2c_client->addr;
		msg.flags = 0;
		msg.len = len%onetime_down_byte;
		if(len > onetime_down_byte) msg.buf = (char *)a2020_firmware_image1+(firmware_index);
		else msg.buf = (char *)a2020_firmware_image1;
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
		    printk( "[Snd_audience_a2020] aud_bootimage_download_1st i2c_transfer Before ------- remain : %d !!!\n",  len%onetime_down_byte);   
#endif
		ret_val = i2c_transfer(audience_a2020_i2c_client->adapter, &msg, 1);
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
		    printk( "[Snd_audience_a2020] aud_bootimage_download_1st i2c_transfer After --------- !!! [[ loop_cnt : %d   len : %d]] \n",loop_cnt, len);   
#endif
		if (ret_val < 0){
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
		    printk( "[Snd_audience_a2020] aud_bootimage_download_1st NOK !!!\n");   
    ...
    ret_val = i2c_transfer(audience_a2020_i2c_client->adapter, &msg, 1);
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_bootimage_download_1st i2c_transfer After !!!\n");   
#endif
    if (ret_val < 0){
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_bootimage_download_1st NOK !!!\n");   
...
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_bootimage_download_2st i2c_transfer Before !!!\n");   
#endif
    ret_val = i2c_transfer(audience_a2020_i2c_client->adapter, &msg, 1);
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_bootimage_download_2st i2c_transfer After !!!\n");   
#endif
    if (ret_val < 0){
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
...
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK	
    printk( "[Snd_audience_a2020] aud_sync_cmd_to_2020 ret_val : %d!!!\n",ret_val);
    //mdelay(100);
#endif	
...
int aud_a2020_sleep_sequence(void)
{
    int ret_val = 1;
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] A2020 Sleep Sequence Start !!!\n");
#endif		
...
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] A2020 Sleep Sequence End !!!\n");
#endif		
    return ret_val;
}
...
AGAIN_BOOT:
    ...
    bBootSequence = 0;
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_boot_cmd_to_2020 Chip Reset start !!!\n");
#endif		
...
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_boot_cmd_to_2020 Chip Reset End !!!\n");
#endif		

	
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_boot_cmd_to_2020 Start !!!\n");
        printk( "[Snd_audience_a2020] aud_boot_cmd_to_2020 Start !!!\n");
#endif		
    ret_val = aud_boot_cmd_to_2020();
#ifdef CONFIG_AUDIENCE_DEBUG_PRINTK
        printk( "[Snd_audience_a2020] aud_boot_cmd_to_2020 End !!!\n");
#endif		
...
{
 	int rc = 0;
pr_info("~~~~~~~~~~~~~~~~~pz1946 audience_a2020_probe start\n");	
